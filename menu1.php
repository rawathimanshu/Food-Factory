...
<body>
    ...
    <section class="navbar">
        ...
        ?>
                    ...
                    <li>
        <a href="<?php echo SITEURL;?>sinup.php">

            <?php

       
         //$_SESSION['uname'];
         $_SESSION['Sinup'] = "Signup";
        ...
        echo "<a title='You are Signup'>". $_SESSION['name']." </a>";
    ...
    echo "<a href='sinup.php' style= 'float:right';>". $_SESSION['Sinup'] ."</a>";
